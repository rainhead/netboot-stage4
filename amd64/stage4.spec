...
stage4/use: ipv6 ssl caps zeroconf mdnsresponder-compat dbus bash-completion -python -gtk -alsa netboot tftp ccache vim-syntax
...
# example:
# stage4/rcadd:
stage4/rcadd: vixie-cron|default syslog-ng|default avahi-daemon|default ntpd|default ipmievd|default
...
# example:
# stage4/root_overlay:
stage4/root_overlay: /root/catalyst/overlay/stage4
...
boot/kernel/gentoo/config: /root/catalyst/kernel/generic
